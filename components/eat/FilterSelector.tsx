  ...
  return (
    <div className="space-y-3 text-left">
      ...
      <select
        ...
        className="w-full rounded-xl bg-gray-700 px-4 py-3 text-sm font-bold text-white md:bg-gray-100 md:text-gray-700"
      >
      ...
      <button
        ...
        className="w-full rounded-xl bg-gray-700 px-3 py-3 text-sm font-bold text-gray-300 md:bg-gray-200 md:text-gray-600"
      >
        브랜드 초기화
      </button>
    </div>
