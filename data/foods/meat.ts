...
export const meatFoods: Food[] = [
  ...
  createFood({ id: 4034, name: "스테이크", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 30000, spicy: 0, tags: ["고기", "양식", "저녁", "특별한날"], situations: ["데이트", "특별한날"], eatAlone: true, message: "오늘은 스테이크로 제대로 먹어보자!" }),
  createFood({ id: 4035, name: "안심스테이크", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 35000, spicy: 0, tags: ["고기", "양식", "저녁", "특별한날"], situations: ["데이트", "특별한날"], eatAlone: true, message: "부드럽고 진한 안심스테이크 어때?" }),
  createFood({ id: 4036, name: "채끝스테이크", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 38000, spicy: 0, tags: ["고기", "양식", "저녁", "특별한날"], situations: ["데이트", "특별한날"], eatAlone: true, message: "채끝스테이크 한 점에 오늘의 피로가 날아가!" }),
  createFood({ id: 4037, name: "등심스테이크", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 40000, spicy: 0, tags: ["고기", "양식", "저녁", "특별한날"], situations: ["데이트", "특별한날"], eatAlone: true, message: "육즙 가득 등심스테이크 어때?" }),
  createFood({ id: 4038, name: "티본스테이크", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 55000, spicy: 0, tags: ["고기", "양식", "저녁", "특별한날", "모임"], situations: ["특별한날", "친구와"], eatAlone: true, message: "티본스테이크! 오늘 이거 먹을 자격 있잖아?" }),
  createFood({ id: 4039, name: "토마호크스테이크", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 80000, spicy: 0, tags: ["고기", "양식", "저녁", "특별한날", "모임"], situations: ["특별한날", "가족과"], eatAlone: false, message: "토마호크, 오늘만큼은 제대로 대접받을 날!" }),
  createFood({ id: 4040, name: "함박스테이크", emoji: "🍳", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 15000, spicy: 0, tags: ["고기", "양식", "점심", "저녁"], situations: ["든든함", "가성비"], eatAlone: true, message: "육즙 터지는 함박스테이크 어때?" }),
  createFood({ id: 4041, name: "찹스테이크", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 20000, spicy: 0, tags: ["고기", "양식", "점심", "저녁"], situations: ["든든함"], eatAlone: true, message: "야채 듬뿍 찹스테이크 어때?" }),
  createFood({ id: 4042, name: "비프웰링턴", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 60000, spicy: 0, tags: ["고기", "양식", "저녁", "특별한날"], situations: ["특별한날", "데이트"], eatAlone: true, message: "특별한 날엔 비프웰링턴으로 격식 있게!" }),
  createFood({ id: 4043, name: "로스트비프", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 25000, spicy: 0, tags: ["고기", "양식", "점심", "저녁"], situations: ["특별한날"], eatAlone: true, message: "슬라이스 로스트비프 한 접시 어때?" }),
  createFood({ id: 4044, name: "폭립", emoji: "🍖", category: "고기", additionalCategories: ["양식"], subCategory: "립", cuisine: "양식", price: 28000, spicy: 0, tags: ["고기", "양식", "저녁", "모임"], situations: ["친구와", "특별한날"], eatAlone: false, message: "뜯어먹는 재미 폭립 어때?" }),
  createFood({ id: 4045, name: "바비큐립", emoji: "🍖", category: "고기", additionalCategories: ["양식"], subCategory: "립", cuisine: "양식", price: 30000, spicy: 0, tags: ["고기", "양식", "저녁", "모임"], situations: ["친구와", "특별한날"], eatAlone: false, message: "스모키한 바비큐립 한 판 어때?" }),
  createFood({ id: 4046, name: "그릴드치킨", emoji: "🍗", category: "고기", additionalCategories: ["양식"], subCategory: "그릴", cuisine: "양식", price: 18000, spicy: 0, tags: ["고기", "양식", "점심", "저녁", "건강식"], situations: ["건강", "가벼움"], eatAlone: true, message: "담백한 그릴드치킨으로 건강하게!" }),
  createFood({ id: 4047, name: "치킨스테이크", emoji: "🍗", category: "고기", additionalCategories: ["양식"], subCategory: "그릴", cuisine: "양식", price: 20000, spicy: 0, tags: ["고기", "양식", "점심", "저녁"], situations: ["든든함"], eatAlone: true, message: "두툼한 치킨스테이크 어때?" }),
  createFood({ id: 4048, name: "허브치킨", emoji: "🌿", category: "고기", additionalCategories: ["양식"], subCategory: "그릴", cuisine: "양식", price: 20000, spicy: 0, tags: ["고기", "양식", "점심", "저녁", "건강식"], situations: ["건강", "가벼움"], eatAlone: true, message: "허브향 가득한 허브치킨 어때?" }),
  createFood({ id: 4049, name: "치킨커틀릿", emoji: "🍗", category: "고기", additionalCategories: ["양식"], subCategory: "돈가스", cuisine: "양식", price: 15000, spicy: 0, tags: ["고기", "양식", "점심", "저녁"], situations: ["든든함", "가성비"], eatAlone: true, message: "바삭한 치킨커틀릿 어때?" }),
  createFood({ id: 4050, name: "포크커틀릿", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "돈가스", cuisine: "양식", price: 15000, spicy: 0, tags: ["고기", "양식", "점심", "저녁"], situations: ["든든함", "가성비"], eatAlone: true, message: "바삭한 포크커틀릿 어때?" }),
  createFood({ id: 4051, name: "포크찹", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "그릴", cuisine: "양식", price: 22000, spicy: 0, tags: ["고기", "양식", "저녁"], situations: ["든든함", "특별한날"], eatAlone: true, message: "두툼한 포크찹 구워서 한 접시!" }),
  createFood({ id: 4052, name: "양갈비스테이크", emoji: "🥩", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 45000, spicy: 0, tags: ["고기", "양식", "저녁", "특별한날"], situations: ["특별한날", "데이트"], eatAlone: true, message: "풍미 가득 양갈비스테이크 어때?" }),
  createFood({ id: 4053, name: "연어스테이크", emoji: "🐟", category: "고기", additionalCategories: ["양식"], subCategory: "스테이크", cuisine: "양식", price: 28000, spicy: 0, tags: ["고기", "양식", "저녁", "건강식", "해산물"], situations: ["건강", "데이트"], eatAlone: true, message: "촉촉한 연어스테이크 어때?" }),
  createFood({ id: 4054, name: "그릴드연어", emoji: "🐟", category: "고기", additionalCategories: ["양식"], subCategory: "그릴", cuisine: "양식", price: 25000, spicy: 0, tags: ["고기", "양식", "저녁", "건강식", "해산물"], situations: ["건강", "가벼움"], eatAlone: true, message: "담백한 그릴드연어 어때?" }),
];
